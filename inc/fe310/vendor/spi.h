...
#define IOF0_SPI1_CS0 BITMASK(2)
#define IOF0_SPI1_DQ0 BITMASK(3)
#define IOF0_SPI1_DQ1 BITMASK(4)
#define IOF0_SPI1_SCK BITMASK(5)
#define IOF0_SPI1_DQ2 BITMASK(6)
#define IOF0_SPI1_DQ3 BITMASK(7)
#define IOF0_SPI1_CS1 BITMASK(8)
#define IOF0_SPI1_CS2 BITMASK(9)
#define IOF0_SPI1_CS3 BITMASK(10)
#define IOF0_SPI2_CS0 BITMASK(26)
#define IOF0_SPI2_DQ0 BITMASK(27)
#define IOF0_SPI2_DQ1 BITMASK(28)
#define IOF0_SPI2_SCK BITMASK(29)
#define IOF0_SPI2_DQ2 BITMASK(30)
#define IOF0_SPI2_DQ3 BITMASK(31)
